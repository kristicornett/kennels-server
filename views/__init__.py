import json
from .animal_requests import get_all_animals, create_animal, update_animal
from .animal_requests import get_single_animal, delete_animal
...
from .employee_requests import delete_employee, update_employee
from .customer_requests import get_all_customers, get_single_customer, create_customer
from .customer_requests import delete_customer, update_customer
