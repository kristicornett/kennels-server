import json
from .animal_requests import get_all_animals, create_animal, update_animal, get_animal_by_status
from .animal_requests import get_single_animal, delete_animal, get_animal_by_location
